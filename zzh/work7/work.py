...
MX = MOOCXING.INIT()
mc = Minecraft.create()
xclf=cv2.imread('baiduaip\\photo_sourse\\XCLF.jpg')
lcjj=cv2.imread('baiduaip\\photo_sourse\\LCJJ.jpg')
lz=cv2.imread('baiduaip\\photo_sourse\\LZ.jpg')
xcfzj=cv2.imread('baiduaip\\photo_sourse\\XCFRJ.jpg')
xjjy=cv2.imread('baiduaip\\photo_sourse\\XJJY.jpg')
yb=cv2.imread('baiduaip\\photo_sourse\\YB.jpg')
zwy=cv2.imread('baiduaip\\photo_sourse\\ZWY.jpg')
zxt=cv2.imread('baiduaip\\photo_sourse\\ZXT.jpg')
cookerpos = [-1041,59,297]
def get_dis():
